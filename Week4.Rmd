...
-   **Inhibition**: The effects of one drug are eliminated by the presence of another drug at the receptor site.
      ...
      -   **Cross-Tolerance**: occurs when a person develops a physiological tolerance to one drug that also increases the body’s tolerance to other substances that act similarly on the body.
